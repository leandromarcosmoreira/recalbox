...
f_cp /boot/recalbox-backup.conf                                   "${DSYSTEM}/boot"
...
test -d "/recalbox/share/system/.config" && rsync -a "/recalbox/share/system/.config" "${TMPDIR}"
