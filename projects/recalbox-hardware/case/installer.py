...
MODULES = {
    ...
    "installers.argononev3.install": (cases.ARGONONEV3,),
    "installers.retroflags.install": (cases.SUPERPI4CASE, cases.NESPI4, cases.NESPI4MANUAL, cases.PISTATION, cases.NESPICASEPLUS, cases.SUPERPICASE, cases.MEGAPICASE, cases.SIXTYFOURPICASE, cases.DREAMCASE),
    "installers.raspberrypi-touch-display.install": (cases.RPITOUCHDISPLAY,),
    "installers.steamdecklcd.install": (cases.STEAMDECKLCD,),
    "installers.steamdeckoled.install": (cases.STEAMDECKOLED,),
}
