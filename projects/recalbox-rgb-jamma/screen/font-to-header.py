...
def main():
    ...
    parser.add_argument('-s','--fontsize', default='32', choices=['7','8','12','16', '24', '32', '40', '48', '56', '64', 'all'], help='Fontsize (Fontheight) in pixels. Default: 32')
    ...
    parser.add_argument('--font_height', help='Define fontsize of rendered font within the defined pixel image boundary')
    ...
    if len(sys.argv) == 1:
        ...
        font_heights =  [7, 8, 12, 16, 24, 32, 40, 48, 56, 64]
        ...
        for ttf_file in TTF_FILES:
            ...
            for height_idx in height_indices:
                ...
                outfile = write_bmh_head(h_filename, ttf_filename, height)
...
# Process BMF array and create header file to be used with any C compiler
    ...
    outfile.write("const uint8_t {}{}x{}[] = {{\n".format(Font, height, height))
...
def write_bmh_char(outfile, char, dot_array, progmem):
    outfile.write(','.join('0x{:02X}'.format(int(a)) for a in dot_array))
    outfile.write(", // {}\n".format(char).replace("\\",""))
