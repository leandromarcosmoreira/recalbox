  ...
  , private ISyncMessageReceiver<void>
{
  public:
     ...
     */
    void SetText(const String& text, bool keepHighestWidth = false) { mBusyAnim.SetText(text, keepHighestWidth); }

    /*!
     * @brief Set secondary animation text
     * @param text text to set
     */
    void SetSecondaryText(const String& text) { mBusyAnim.SetSecondaryText(text); }

    /*!
     * @brief Set optionnal progress bar value and make the progress bar to show
     * @param progress Progress value
     */
    void SetProgress(int progress) { mBusyAnim.SetProgress(progress); }

    /*!
     * @brief Get animation text
     * @return Text
     */
    String GetText() { return mBusyAnim.getText(); }
     ...
     */
    bool CollectHelpItems(Help& help) final { help.Clear(); return true; }
