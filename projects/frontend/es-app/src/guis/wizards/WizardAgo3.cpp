...
void WizardAgo3::OnHelpRequired(int page, Help &help)
{
  switch((Pages)page)
  {
    case Pages::Intro: help.Set(Help::Valid(), _("OK")); help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::StartButton: help.Set(HelpType::Start, "START"); help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::SelectButton: help.Set(HelpType::Select, "SELECT"); help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::L3R3: help.Set(HelpType::L3R3, "L3/R3"); help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::BrightnessButtons: help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::VolumeButtons:
    case Pages::PowerSuspend:
    case Pages::PowerOff:
    case Pages::Jack:
    case Pages::Final: help.Set(Help::Valid(), _("OK")); help.Set(HelpType::UpDown, _("LANGUAGE")); break;
    case Pages::Count: break;
  }
}
