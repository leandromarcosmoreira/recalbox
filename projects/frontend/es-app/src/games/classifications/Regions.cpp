...
String Regions::Serialize4Regions(const Regions::RegionPack& regions)
{
  String result;
...
int Regions::OrderedMasterRegionsTo8Regions(Regions::OrderedMasterRegions master, long long int& regions)
{
  #define To4Regions(a, b, c, d) ({ regions = (((long long int)GameRegions::a) | ((long long int)GameRegions::b << 8) | ((long long int)GameRegions::c << 16) | ((long long int)GameRegions::d << 24)); 4; })
  #define To5Regions(a, b, c, d, e) ({ regions = (((long long int)GameRegions::a) | ((long long int)GameRegions::b << 8) | ((long long int)GameRegions::c << 16) | ((long long int)GameRegions::d << 24) | ((long long int)GameRegions::e << 32)); 5; })
  switch(master)
  {
    case OrderedMasterRegions::WorUsEuJp: return To4Regions(WOR, US, EU, JP);
    case OrderedMasterRegions::WorUsJpEu: return To4Regions(WOR, US, JP, EU);
    case OrderedMasterRegions::WorEuUsJp: return To4Regions(WOR, EU, US, JP);
    case OrderedMasterRegions::WorEuJpUs: return To4Regions(WOR, EU, JP, US);
    case OrderedMasterRegions::WorJpUsEu: return To4Regions(WOR, JP, US, EU);
    case OrderedMasterRegions::WorJpEuUs: return To4Regions(WOR, JP, EU, US);
    case OrderedMasterRegions::UsWorEuJp: return To4Regions(US, WOR, EU, JP);
    case OrderedMasterRegions::UsWorJpEu: return To4Regions(US, WOR, JP, EU);
    case OrderedMasterRegions::UsEuWorJp: return To4Regions(US, EU, WOR, JP);
    case OrderedMasterRegions::UsEuJpWor: return To4Regions(US, EU, JP, WOR);
    case OrderedMasterRegions::UsJpWorEu: return To4Regions(US, JP, WOR, EU);
    case OrderedMasterRegions::UsJpEuWor: return To4Regions(US, JP, EU, WOR);
    case OrderedMasterRegions::EuWorUsJp: return To4Regions(EU, WOR, US, JP);
    case OrderedMasterRegions::EuWorJpUs: return To4Regions(EU, WOR, JP, US);
    case OrderedMasterRegions::EuUsWorJp: return To4Regions(EU, US, WOR, JP);
    case OrderedMasterRegions::EuUsJpWor: return To4Regions(EU, US, JP, WOR);
    case OrderedMasterRegions::EuJpWorUs: return To4Regions(EU, JP, WOR, US);
    case OrderedMasterRegions::EuJpUsWor: return To4Regions(EU, JP, US, WOR);
    case OrderedMasterRegions::JpWorUsEu: return To4Regions(JP, WOR, US, EU);
    case OrderedMasterRegions::JpWorEuUs: return To4Regions(JP, WOR, EU, US);
    case OrderedMasterRegions::JpUsWorEu: return To4Regions(JP, US, WOR, EU);
    case OrderedMasterRegions::JpUsEuWor: return To4Regions(JP, US, EU, WOR);
    case OrderedMasterRegions::JpEuWorUs: return To4Regions(JP, EU, WOR, US);
    case OrderedMasterRegions::JpEuUsWor: return To4Regions(JP, EU, US, WOR);
    case OrderedMasterRegions::AsiWorUsEuJp: return To5Regions(ASI, WOR, US, EU, JP);
    case OrderedMasterRegions::AsiWorUsJpEu: return To5Regions(ASI, WOR, US, JP, EU);
    case OrderedMasterRegions::AsiWorJpUsEu: return To5Regions(ASI, WOR, JP, US, EU);
    case OrderedMasterRegions::AsiWorJpEuUs: return To5Regions(ASI, WOR, JP, EU, US);
    case OrderedMasterRegions::AmeWorUsEuJp: return To5Regions(AME, WOR, US, EU, JP);
    case OrderedMasterRegions::AmeWorEuUsJp: return To5Regions(AME, WOR, EU, US, JP);
    case OrderedMasterRegions::AmeUsWorEuJp: return To5Regions(AME, US, WOR, EU, JP);
    case OrderedMasterRegions::AmeEuWorUsJp: return To5Regions(AME, EU, WOR, US, JP);
    case OrderedMasterRegions::__Count:
    default: break;
  }
...
const String& Regions::OrderedMasterRegionsFromEnum(Regions::OrderedMasterRegions master)
{
  switch(master)
  {
    case OrderedMasterRegions::WorUsEuJp: { static String s("World > USA > Europe > Japan"); return s; }
    case OrderedMasterRegions::WorUsJpEu: { static String s("World > USA > Japan > Europe"); return s; }
    case OrderedMasterRegions::WorEuUsJp: { static String s("World > Europe > USA > Japan"); return s; }
    case OrderedMasterRegions::WorEuJpUs: { static String s("World > Europe > Japan > USA"); return s; }
    case OrderedMasterRegions::WorJpUsEu: { static String s("World > Japan > USA > Europe"); return s; }
    case OrderedMasterRegions::WorJpEuUs: { static String s("World > Japan > Europe > USA"); return s; }
    case OrderedMasterRegions::UsWorEuJp: { static String s("USA > World > Europe > Japan"); return s; }
    case OrderedMasterRegions::UsWorJpEu: { static String s("USA > World > Japan > Europe"); return s; }
    case OrderedMasterRegions::UsEuWorJp: { static String s("USA > Europe > World > Japan"); return s; }
    case OrderedMasterRegions::UsEuJpWor: { static String s("USA > Europe > Japan > World"); return s; }
    case OrderedMasterRegions::UsJpWorEu: { static String s("USA > Japan > World > Europe"); return s; }
    case OrderedMasterRegions::UsJpEuWor: { static String s("USA > Japan > Europe > World"); return s; }
    case OrderedMasterRegions::EuWorUsJp: { static String s("Europe > World > USA > Japan"); return s; }
    case OrderedMasterRegions::EuWorJpUs: { static String s("Europe > World > Japan > USA"); return s; }
    case OrderedMasterRegions::EuUsWorJp: { static String s("Europe > USA > World > Japan"); return s; }
    case OrderedMasterRegions::EuUsJpWor: { static String s("Europe > USA > Japan > World"); return s; }
    case OrderedMasterRegions::EuJpWorUs: { static String s("Europe > Japan > World > USA"); return s; }
    case OrderedMasterRegions::EuJpUsWor: { static String s("Europe > Japan > USA > World"); return s; }
    case OrderedMasterRegions::JpWorUsEu: { static String s("Japan > World > USA > Europe"); return s; }
    case OrderedMasterRegions::JpWorEuUs: { static String s("Japan > World > Europe > USA"); return s; }
    case OrderedMasterRegions::JpUsWorEu: { static String s("Japan > USA > World > Europe"); return s; }
    case OrderedMasterRegions::JpUsEuWor: { static String s("Japan > USA > Europe > World"); return s; }
    case OrderedMasterRegions::JpEuWorUs: { static String s("Japan > Europe > World > USA"); return s; }
    case OrderedMasterRegions::JpEuUsWor: { static String s("Japan > Europe > USA > World"); return s; }
    case OrderedMasterRegions::AsiWorUsEuJp: { static String s("Asia > World > USA > Europe > Japan"); return s; }
    case OrderedMasterRegions::AsiWorUsJpEu: { static String s("Asia > World > USA > Japan > Europe"); return s; }
    case OrderedMasterRegions::AsiWorJpUsEu: { static String s("Asia > World > Japan > USA > Europe"); return s; }
    case OrderedMasterRegions::AsiWorJpEuUs: { static String s("Asia > World > Japan > Europe > USA"); return s; }
    case OrderedMasterRegions::AmeWorUsEuJp: { static String s("Latin America > World > USA > Europe > Japan"); return s; }
    case OrderedMasterRegions::AmeWorEuUsJp: { static String s("Latin America > World > Europe > USA > Japan"); return s; }
    case OrderedMasterRegions::AmeUsWorEuJp: { static String s("Latin America > USA > World > Europe > Japan"); return s; }
    case OrderedMasterRegions::AmeEuWorUsJp: { static String s("Latin America > Europe > World > USA > Japan"); return s; }
    case OrderedMasterRegions::__Count:
    default: break;
  }
...
Regions::OrderedMasterRegions Regions::OrderedMasterRegionsFromString(const String& master)
{
  static HashMap<String, OrderedMasterRegions> sMap
  {
    { "World > USA > Europe > Japan"                 , OrderedMasterRegions::WorUsEuJp    },
    { "World > USA > Japan > Europe"                 , OrderedMasterRegions::WorUsJpEu    },
    { "World > Europe > USA > Japan"                 , OrderedMasterRegions::WorEuUsJp    },
    { "World > Europe > Japan > USA"                 , OrderedMasterRegions::WorEuJpUs    },
    { "World > Japan > USA > Europe"                 , OrderedMasterRegions::WorJpUsEu    },
    { "World > Japan > Europe > USA"                 , OrderedMasterRegions::WorJpEuUs    },
    { "USA > World > Europe > Japan"                 , OrderedMasterRegions::UsWorEuJp    },
    { "USA > World > Japan > Europe"                 , OrderedMasterRegions::UsWorJpEu    },
    { "USA > Europe > World > Japan"                 , OrderedMasterRegions::UsEuWorJp    },
    { "USA > Europe > Japan > World"                 , OrderedMasterRegions::UsEuJpWor    },
    { "USA > Japan > World > Europe"                 , OrderedMasterRegions::UsJpWorEu    },
    { "USA > Japan > Europe > World"                 , OrderedMasterRegions::UsJpEuWor    },
    { "Europe > World > USA > Japan"                 , OrderedMasterRegions::EuWorUsJp    },
    { "Europe > World > Japan > USA"                 , OrderedMasterRegions::EuWorJpUs    },
    { "Europe > USA > World > Japan"                 , OrderedMasterRegions::EuUsWorJp    },
    { "Europe > USA > Japan > World"                 , OrderedMasterRegions::EuUsJpWor    },
    { "Europe > Japan > World > USA"                 , OrderedMasterRegions::EuJpWorUs    },
    { "Europe > Japan > USA > World"                 , OrderedMasterRegions::EuJpUsWor    },
    { "Japan > World > USA > Europe"                 , OrderedMasterRegions::JpWorUsEu    },
    { "Japan > World > Europe > USA"                 , OrderedMasterRegions::JpWorEuUs    },
    { "Japan > USA > World > Europe"                 , OrderedMasterRegions::JpUsWorEu    },
    { "Japan > USA > Europe > World"                 , OrderedMasterRegions::JpUsEuWor    },
    { "Japan > Europe > World > USA"                 , OrderedMasterRegions::JpEuWorUs    },
    { "Japan > Europe > USA > World"                 , OrderedMasterRegions::JpEuUsWor    },
    { "Asia > World > USA > Europe > Japan"          , OrderedMasterRegions::AsiWorUsEuJp },
    { "Asia > World > USA > Japan > Europe"          , OrderedMasterRegions::AsiWorUsJpEu },
    { "Asia > World > Japan > USA > Europe"          , OrderedMasterRegions::AsiWorJpUsEu },
    { "Asia > World > Japan > Europe > USA"          , OrderedMasterRegions::AsiWorJpEuUs },
    { "Latin America > World > USA > Europe > Japan" , OrderedMasterRegions::AmeWorUsEuJp },
    { "Latin America > World > Europe > USA > Japan" , OrderedMasterRegions::AmeWorEuUsJp },
    { "Latin America > USA > World > Europe > Japan" , OrderedMasterRegions::AmeUsWorEuJp },
    { "Latin America > Europe > World > USA > Japan" , OrderedMasterRegions::AmeEuWorUsJp },
  };

  OrderedMasterRegions* result = sMap.try_get(master);
  return result != nullptr ? *result : OrderedMasterRegions::WorEuUsJp;
}
