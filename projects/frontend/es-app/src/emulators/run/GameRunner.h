                   ...
                   , public IScraperEngineFreezer
{
  public:
    ...
    /*!
     * @brief Run game
     * @param resolutionAdapter Resolution adapter instance
     * @param game Game to run
     * @param emulator Emulator data
     * @param data Game related information
     * @return True if the game ran fine, false otherwise
     */
    bool RunGame(ResolutionAdapter& resolutionAdapter, FileData& game, const EmulatorData& emulator, const GameLinkedData& data);
     ...
     */
    String CreateCommandLine(ResolutionAdapter& resolutionAdapter, const FileData& game, const EmulatorData& emulator, const String& core, const GameLinkedData& data,const InputMapper& mapper, bool debug, bool demo);
     ...
     */
    bool DemoRunGame(ResolutionAdapter& resolutionAdapter, const FileData& game, const EmulatorData& emulator, int duration, int infoscreenduration);
  ...
  private:
     ...
     */
    static String BuildCRTOptions(const FileData& game, const EmulatorData& emulator, const CrtData& data, RotationType rotation, const bool demo);
    ...
    */
     ...
     * @return Governance
     */
    static IBoardInterface::PerformanceGovernance GetGovernance(const String& core);
