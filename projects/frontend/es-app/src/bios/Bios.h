...
class Bios
{
  ...
  public:
     ...
     */
    [[nodiscard]] bool IsMD5Known(const String& md5) const;
    ...
    //! Bios file path
    [[nodiscard]] String FilepathWithParent() const { return (mPath[0].IsAbsolute() ? mPath[0] : (sBiosPath / mPath[0])).ToString(); }
