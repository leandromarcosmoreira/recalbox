...
class Allocator
{
  ...
  protected:
    ...
    //! Raw memory accessor
    [[nodiscard]] void* Memory() const { return mMemory; }

  public:
    //! Return Granularity in bytes
    [[nodiscard]] int Granularity() const { return (1 << (int)mLog2Granularity); }
    //! Return Capacity in bytes
    [[nodiscard]] int Capacity() const { return (int)mMultiplier << (int)mLog2Granularity; }
