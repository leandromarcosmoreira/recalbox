...
public:
   ...
   * @return
   */
  [[nodiscard]] String ToISO8601() const { return ToStringFormat("%YYYY-%MM-%ddT%HH:%mm:%ss.%fff%zzzz"); }

  /*!
   * Return the current DateTime in an ISO8601 string format: YYYY-MM-ddTHH:mm:ss+zzzz
   * @return
   */
  [[nodiscard]] String ToCompactISO8601() const { return ToStringFormat("%YYYY%MM%ddT%HH%mm%ss"); }

  /*!
   * Return the current DateTime in an ISO8601 string format: YYYY-MM-ddTHH:mm:ss.fff+zzzz
   * @return
   */
  [[nodiscard]] String ToDateISO8601() const { return ToStringFormat("%YYYY-%MM-%dd"); }

  /*!
   * Return the current DateTime in an ISO8601 string format: YYYY-MM-ddTHH:mm:ss+zzzz
   * @return
   */
  [[nodiscard]] String ToCompactDateISO8601() const { return ToStringFormat("%YYYY%MM%dd"); }

  /*!
   * Return very compact 14 digit DateTime representation
   * @return Compact representation of the current DateTime
   */
  [[nodiscard]] String ToCompactFormat() const { return ToStringFormat("%YYYY%MM%dd%HH%mm%ss"); }

  /*!
   * Return short DateTime representation
   * @return Short representation of the current DateTime
   */
  [[nodiscard]] String ToShortFormat() const { return ToStringFormat("%YYYY/%MM/%dd %HH:%mm:%ss%zz"); }

  /*!
   * Return precise timestamp DateTime representation
   * @return Short representation of the current DateTime
   */
  [[nodiscard]] String ToPreciseTimeStamp() const { return ToStringFormat("%YYYY/%MM/%dd %HH:%mm:%ss.%fff"); }
