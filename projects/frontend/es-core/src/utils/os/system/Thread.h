...
class Thread
{
  public:
     ...
     * @param relativePriority value between -19 (highest priority) to 20 (lowest priority)
     */
    explicit Thread(int relativePriority = 0);
     ...
     * @param relativePriority value between -19 (highest priority) to 20 (lowest priority)
     */
    void Start(const String& name, int relativePriority = 0);
