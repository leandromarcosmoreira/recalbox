...
class Pi500PowerEventReader : private Thread
{
public:
    //! Constructor
    explicit Pi500PowerEventReader(HardwareMessageSender& messageSender);

    ~Pi500PowerEventReader() override;
...
private:
    ...
    //! Event to read
    //! On Pi500 internal keyboard EventId can change depending on what is connected (mouse, pad)
