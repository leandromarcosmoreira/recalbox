...
class RG353XBoard: public IBoardInterface
{
  ...
  private:
    ...
    static constexpr const char* sDmcGovernancePath   = "/sys/class/devfreq/dmc/governor"; // TODO
    static constexpr const char* sBatteryCapacityPath = "/sys/class/power_supply/rk817-battery/capacity";
    static constexpr const char* sBatteryStatusPath   = "/sys/class/power_supply/rk817-battery/status";
...
//      if (mModel == BoardType::RG353V)
     ...
     */
    bool HasPerformanceGovernance() final
    { return true; }
