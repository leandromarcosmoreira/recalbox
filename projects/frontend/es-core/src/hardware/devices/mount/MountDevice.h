...
class DeviceMount
{
  public:
    ...
    DeviceMount(const DeviceMount&) = default;
    DeviceMount(DeviceMount&&) = default;
    ...
    DeviceMount& operator=(const DeviceMount&) = default;
    DeviceMount& operator=(DeviceMount&&) = default;
