...
class Case
{
  public:
     ...
     * @return true if the case is automatically detected by the system
     */
     ...
     * @return a nice and human readable name
     */
    ...
    /*!
     * @brief Has ON/OFF shutdown button
     * @return
     */
    bool HasShutdownOnOffButton();
    ...
    /*!
     * @brief Returns if a case is installed
