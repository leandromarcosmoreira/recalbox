...

{
  ...
  private:
    ...
    //! Last active sink index
    int mActiveSinkIndex;
    //! Last volume read
    int mLastVolume;
    ...
    /*!
     * @brief Callback called when we get volume from pulseaudio
     * @param context Pulseaudio context
     * @param info Sink information structure
     * @param eol End-of-list flag
     * @param userdata This
     */
    static void GetVolumeCallback(pa_context *context, const pa_sink_info* info, int eol, void *userdata);
