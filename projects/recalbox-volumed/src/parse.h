...
struct volumed_arguments {
  bool debug;
  bool foreground;;
  char * hotkey_inputdevice_name;
  unsigned short hotkey_code;
  bool use_abs_volume;
  // legacy options
  char * input_name;
};

typedef struct volumed_arguments volumed_arguments;

extern volumed_arguments arguments;
