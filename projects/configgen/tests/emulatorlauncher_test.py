...
@pytest.mark.parametrize(
    'emulator',
    [
        "libretro", "advancemame", "amiberry",    "corsixth",     "daphne",
        "dolphin",  "dosbox",      "duckstation", "fba2x",        "gsplus",
        "julius",   "kodi",        "moonlight",    "mupen64plus",
        "openbor",  "openlara",    "oricutron",   "pcsx_rearmed", "pisnes",
        "ppsspp",   "reicast",     "scummvm",     "sdlpop",       "simcoupe",
        "solarus",  "supermodel",  "vice"
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("3ds", {'emulator': "libretro", 'core': "citra_canary", 'resolution': "default", 'ratio': "auto"}),
        ("64dd", {'emulator': "libretro", 'core': "parallel_n64", 'resolution': "default", 'ratio': "auto"}),
    ],
)
def test_getDefaultEmulator(targetsystem, emulator):
    default_emulator: Emulator = emulatorlauncher.getDefaultEmulator(targetsystem, emulator['emulator'], emulator['core'], emulator['resolution'], emulator['ratio'])
