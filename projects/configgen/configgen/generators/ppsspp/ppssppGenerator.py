...
class PPSSPPGenerator(Generator):
    ...
    controlsFile = recalboxFiles.CONF + '/ppsspp/gamecontrollerdb.txt'
    savesFolder = recalboxFiles.SAVES + '/psp'
    ...
    def generate(self, system: Emulator, playersControllers: ControllerPerPlayer, recalboxOptions: keyValueSettings, args) -> Command:
        ...
        if not system.HasConfigFile:
            ...
            for index in playersControllers:
                ...
                cfgFile = open(self.controlsFile, "w")
        ...
        return Command(videomode=system.VideoMode, array=commandArray, env={"XDG_CONFIG_HOME": self.savesFolder, "SDL_VIDEO_GL_DRIVER": "/usr/lib/libGLESv2.so", "SDL_VIDEO_EGL_DRIVER": "/usr/lib/libEGL.so", "PPSSPP_GAME_CONTROLLER_DB_PATH": self.controlsFile}, delay=1)
