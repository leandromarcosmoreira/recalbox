...
class DosBoxGenerator(Generator):
    ...
    def generate(self, system: Emulator, playersControllers: ControllerPerPlayer, recalboxOptions: keyValueSettings, args) -> Command:
        ...
        # Surcharging this in dosbox.conf.extra doesn't work for renderer=software
        from configgen.settings.iniSettings import IniSettings
        configSettings = IniSettings(recalboxFiles.dosboxConfig)
        configSettings.loadFile(False).defineBool('true', 'false')
        configSettings.setString("sdl", "renderer", "software")
        configSettings.saveFile()
