...
esLightGun = HOME_INIT + '/.emulationstation/lightgun.xml'
...
recalboxBins =\
{
    ...
    'corsixth'    : '/usr/bin/corsix-th',
    'daphne'      : '/usr/bin/hypseus',
    'dolphin'     : '/usr/bin/dolphin',
    'dolphin-gui' : '/usr/bin/dolphin-gui',
...
retroarchSwitchres = HOME + "/.config/retroarch/config/switchres.ini"
