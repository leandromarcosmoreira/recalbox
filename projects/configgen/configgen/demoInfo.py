class demoInformation:
    ...
    # font
    FONT_PATH = "/recalbox/share_init/system/.emulationstation/themes/recalbox-next/data/fonts/ubuntu_bold.ttf"
    ...
    def loadGameData(self):
        ...
        gameImagePath = gameInfo.getString(self.KEY_GAME_IMAGE_PATH, "/recalbox/system/resources/splash/no_image.png")
        del gameInfo
