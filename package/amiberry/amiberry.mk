...
define AMIBERRY_INSTALL_TARGET_CMDS
	...
	# Copy RTB files
	mkdir -p $(TARGET_DIR)/recalbox/share_upgrade/bios/amiga/bios/ && \
		cp $(@D)/whdboot/save-data/Kickstarts/*.RTB $(TARGET_DIR)/recalbox/share_upgrade/bios/amiga/bios/
endef
