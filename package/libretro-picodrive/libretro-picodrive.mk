...
define LIBRETRO_PICODRIVE_BUILD_CMDS
	...
	CFLAGS="$(TARGET_CFLAGS) $(COMPILER_COMMONS_CFLAGS_SO) -I '$(@D)'" \
		...
		$(MAKE) CC="$(TARGET_CC)" CXX="$(TARGET_CXX)" USE_LIBRETRO_VFS=0 -C  $(@D) -f Makefile.libretro platform="$(PICOPLATFORM)" \
		GIT_VERSION="-$(shell echo $(LIBRETRO_PICODRIVE_VERSION) | cut -c 1-8)"
endef
