...
# Commit of 2025/09/08
XEMU_VERSION = v0.8.98
XEMU_SITE = https://github.com/xemu-project/xemu.git
XEMU_SITE_METHOD = git
XEMU_GIT_SUBMODULES = YES
XEMU_LICENSE = GPLv2
XEMU_DEPENDENCIES = sdl2 libsamplerate slirp host-libcurl bzip2 gmp host-python-pyyaml libgbm
XEMU_DEPENDENCIES += libgtk3 libopenssl libpcap pixman python3 xlib_libX11 yaml-cpp zlib

ifeq ($(BR2_PACKAGE_RECALBOX_HAS_VULKAN),y)
XEMU_DEPENDENCIES += vulkan-loader
endif

XEMU_EXTRA_DOWNLOADS = https://github.com/mborgerson/xemu-hdd-image/releases/download/1.0/xbox_hdd.qcow2.zip

XEMU_CONF_ENV += PATH="$(HOST_DIR)/bin:$$PATH"
...
define XEMU_GET_SUBMODULES
  # imgui
	...
	$(HOST_DIR)/bin/curl -L -o imgui.tar.gz \
		http://github.com/xemu-project/imgui/archive/$(REVISION).tar.gz
